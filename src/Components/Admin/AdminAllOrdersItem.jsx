...
const AdminAllOrdersItem = () => {
  ...
  return (
    <Col xs="12" className="cart-item-body my-3 d-flex px-3 align-items-center">
      <Link to={"/admin/orders/23"} className="d-flex w-100">
        <div style={{ maxWidth: "160px", maxHeight: "197px", width: "160px" }}>
          <img width="100%" height="100%" src={mobile} alt="" />
        </div>
        <div className="w-100" >
          ...
          <Row className="justify-content-between">
            <Col sm="12" className=" d-flex  flex-row justify-content-between">
              ...
              <div className="d-inline pt-2 barnd-text ps-2">٣٠٠٠ جنية</div>
            </Col>
          </Row>
        </div>
      </Link>
